        ...
        <form onSubmit={this.createConversation}>
          <div className="flex">
              <div className="input-style">
                ...
                <input id="emails" class="input" type="text" ref={(ref) => { this.emails = ref; }} value={this.state.selected_contacts_string}/>
                <label for="">Ou bien saisissez une ou des adresses emails: </label>
